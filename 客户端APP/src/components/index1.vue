<template>
	<div>
		...
		<div class="baiban">
			...
			<div>
				<div><img src="../assets/1.png" width="100%" height="180px" alt=""></div>
			</div>	
			<div class="content">
				<van-grid :gutter="10" :column-num="3">
					<van-grid-item v-for="value in list3" @click="btn(value.path)" :key="value.id" :icon="value.photo" :text="value.text" />
				</van-grid>
			</div>
